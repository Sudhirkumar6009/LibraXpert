...
const Catalog = () => {
  ...
  const books: Book[] = [
    ...
    },
    {
      ...
      isbn: "9780735619678",
      coverImage:
        "https://m.media-amazon.com/images/I/41nvEPEagML._SX258_BO1,204,203,200_.jpg",
      description:
    ...
    },
    {
      ...
      isbn: "9780262033848",
      coverImage:
        "https://m.media-amazon.com/images/I/41T0iBxY8FL._SX258_BO1,204,203,200_.jpg",
      description:
    ...
    },
    {
      ...
      description:
        "Learn how to uncover the hints and hidden details in a question, discover how to break down a problem into manageable chunks, develop techniques to unstick yourself when stuck, and more.",
    ...
    },
    {
      ...
      isbn: "9780201896831",
      coverImage:
        "https://m.media-amazon.com/images/I/41gCSRxxVeL._SY344_BO1,204,203,200_.jpg",
      description:
