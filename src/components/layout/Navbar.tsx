        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              ...
              <div className="ml-2">
                <span className="text-xl font-semibold text-library-700">LibraXpert</span>
                <span className="text-xs block text-gray-500">Advanced Library Management</span>
              </div>
            </Link>
                  ...
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="relative flex items-center gap-2">
                      ...
                      <div className="text-left hidden lg:block">
                        ...
                        <span className="text-xs block text-gray-500 capitalize">{user?.role}</span>
                      </div>
                    </Button>
                  </DropdownMenuTrigger>
          ...
          {isAuthenticated ? (
            <div className="border-t border-gray-200 pt-4 pb-3">
              <div className="flex items-center px-5">
                ...
                <div className="ml-3">
                  <div className="text-sm font-medium text-library-800">{user?.name}</div>
            ...
            <div className="border-t border-gray-200 pt-4 pb-3">
              <div className="flex flex-col space-y-2 px-4">
                <Button variant="ghost" asChild className="justify-center" onClick={() => setIsMenuOpen(false)}>
                  <Link to="/login">Login</Link>
                </Button>
                <Button asChild className="justify-center" onClick={() => setIsMenuOpen(false)}>
                  <Link to="/register">Register</Link>
                </Button>
              </div>
            </div>
